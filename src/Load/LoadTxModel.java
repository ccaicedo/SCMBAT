...
public class LoadTxModel extends LoadGUI {
	...
	public void setData(SCM_MainWindow scm, TxModel txModel) {
		...
		if (txModel.getSpectrumMask().get(o).getHoppingData() != null) {
			...
			scm.spec.SpecHop.DwellField
					.setText(String.valueOf(txModel.getSpectrumMask().get(o).getHoppingData().getDwellTime()));

			scm.spec.SpecHop.RevisitField
					.setText(String.valueOf(txModel.getSpectrumMask().get(o).getHoppingData().getRevisitPeriod()));

			if (txModel.getSpectrumMask().get(o).getHoppingData().getBandList() != null) {

				List<Band> bandList = txModel.getSpectrumMask().get(o).getHoppingData().getBandList().getBand();
				...
				List<Double> freqList = txModel.getSpectrumMask().get(o).getHoppingData().getFrequencyList()
						.getReferenceFreq();
		...
		// TODO Abhatt need inputs here as i can't see any UI in reciever modal to load
		// data
