...
public class UnderlayRated {
	...
	public UnderlayRated(){
		...
		BandRatLabel.setBounds(25, 565 + 150 , BandRatSize.width, BandRatSize.height);
		
		Dimension BandFieldSize = BandRatField.getPreferredSize();
		BandRatField.setBounds(300, 565 + 150, BandFieldSize.width + 40, 1 + BandFieldSize.height);
		
		// BW List Table
		BWListLabel = new JLabel("Power adjustment offsets definition:");
		Dimension BWLabelSize = BWListLabel.getPreferredSize();
		BWListLabel.setBounds(25, 565 + 150, BWLabelSize.width, BWLabelSize.height);
        ...
        tableContainer2.setBounds(700 - 675, 600 + 150,
                size4.width - 50 , size4.height - 250);
		
        // BW List Buttons
        
        Dimension sizeBtn = Add2.getPreferredSize();
        Add2.setBounds(900 - 425, 600 + 150,
                     sizeBtn.width + 50, sizeBtn.height);
        Remove2.setBounds(900 - 425, 645 + 150,
                sizeBtn.width + 50, sizeBtn.height);
      ...
      table4.putClientProperty("terminateEditOnFocusLost", Boolean.TRUE);
		...
		BTPRatingLabel.setBounds(25, 565 + 150, BTPRatingSize.width, BTPRatingSize.height);
		
		Dimension BTPRatingFieldSize = BTPRatingField.getPreferredSize();
		BTPRatingField.setBounds(300, 565 + 150, BTPRatingFieldSize.width + 40, 1 + BTPRatingFieldSize.height);
		...
		BTPListLabel.setBounds(25, 565 + 150, BTPListLabelSize.width, BTPListLabelSize.height);
		...
		// Policy Field
				...
				PolicyLabel.setBounds(25,565 + 150, PolicySize.width, PolicySize.height);
				
				Dimension PolicyFieldSize = PolicyField.getPreferredSize();
				PolicyField.setBounds(250, 565 + 150, PolicyFieldSize.width + 40, 1 + PolicyFieldSize.height);
		...
		// Duty Cycle List Table
				...
				DutyLabel.setBounds(25, 565 + 150, DutyLabelSize.width, DutyLabelSize.height);
