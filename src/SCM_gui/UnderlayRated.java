...
public class UnderlayRated {
	...
	public UnderlayRated(){
		...
		BandRatLabel.setBounds(25, 535, BandRatSize.width, BandRatSize.height);
		
		Dimension BandFieldSize = BandRatField.getPreferredSize();
		BandRatField.setBounds(300, 535, BandFieldSize.width + 40, 1 + BandFieldSize.height);
		
		// BW List Table
		BWListLabel = new JLabel("Power adjustment offsets definition:");
		Dimension BWLabelSize = BWListLabel.getPreferredSize();
		BWListLabel.setBounds(25, 535, BWLabelSize.width, BWLabelSize.height);
      ...
      table4.putClientProperty("terminateEditOnFocusLost", Boolean.TRUE);
		...
		BTPRatingLabel.setBounds(25, 535, BTPRatingSize.width, BTPRatingSize.height);
		
		Dimension BTPRatingFieldSize = BTPRatingField.getPreferredSize();
		BTPRatingField.setBounds(300, 535, BTPRatingFieldSize.width + 40, 1 + BTPRatingFieldSize.height);
		...
		BTPListLabel.setBounds(25, 535, BTPListLabelSize.width, BTPListLabelSize.height);
		...
		// Policy Field
				...
				PolicyLabel.setBounds(25,535, PolicySize.width, PolicySize.height);
				
				Dimension PolicyFieldSize = PolicyField.getPreferredSize();
				PolicyField.setBounds(300, 535, PolicyFieldSize.width + 40, 1 + PolicyFieldSize.height);
		...
		// Duty Cycle List Table
				...
				DutyLabel.setBounds(25, 535, DutyLabelSize.width, DutyLabelSize.height);
