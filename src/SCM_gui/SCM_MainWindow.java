	...
	public void design(final int Index) {
		...
		final ActionListener exitAction = new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				lblName.setBounds(25 + insetsFrame.left, 3 + insetsFrame.top, Fsize1.width, Fsize1.height);
				...
				SaveExitButton.setBounds(30 + insetsFrame.left, 30 + insetsFrame.top, SaveExitSize.width,
						SaveExitSize.height);
				exitWOSaving.setBounds(30 + insetsFrame.left + SaveExitSize.width + 10, 30 + insetsFrame.top,
						ButtonSize.width, ButtonSize.height);
				cancel.setBounds(30 + insetsFrame.left + SaveExitSize.width + ButtonSize.width + 20,
						30 + insetsFrame.top, SaveExitSize.width, SaveExitSize.height);

				JTextField SField = new JTextField();
				SField.setBounds(25 + insetsFrame.left, 20 + insetsFrame.top, ButtonSize.width + 150,
						ButtonSize.height);
...
//    		
		...
		frame.setSize(1200 + insets.left + insets.right, 900 + insets.top + insets.bottom);
		...
		/*
		 * Defining other Confidence, Reference Power, on the Home Page
		 */

		JLabel ConfText = new JLabel("This construct supports confidence values. If you need to specify a confidence");
		JLabel ConfText2 = new JLabel(
				"value different than 1 for the values of this construct please press this button");
		...
		/*
		 * Deleting Propagation Map, Underlay Mask, IMA Mask and IMC Mask for Receiver
		 * option.
		 */
		if (mode == false) {
		...
		/*
		 * Setting up Policy and Protocol buttons and fields.
		 */
		...
		Save.setBounds(300, 80, size2.width, size2.height);
		Exit.setBounds(300, 130, size2.width, size2.height);
		...
		// imc.imaPrevious.addActionListener(control.new
		// PrevListener("ima",tabbedPane));
