...
//           divElem_3.empty();
	...
	public void displayBTPRatedAnalysis(final ArrayList<String> nonCompatModelList , 
			final ArrayList<String> compatModelList, String reportPath )
	{
		String image_1 = null;
		String image_2 = null;
		String htmlFilename = this.templatePath+"/BTPRatedAnalysis.html";
		String stringHTML = null;
	...
	public void displayDCRatedAnalysis(final ArrayList<String> nonCompatModelList , 
			final ArrayList<String> compatModelList, String reportPath )
	{
		String htmlFilename = this.templatePath+"/DCRatedAnalysis.html";
		String stringHTML = null;
