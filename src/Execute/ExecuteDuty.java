...
/**
* ExecuteDuty.java
* Creates report window to display compatibility results 
* for Duty Cycle rated underlay masks
*/
...
public class ExecuteDuty {
  ...
  //      frame.add(picLabel);
        ...
        JLabel resultLabel = new JLabel("Graphical result (Not available for Duty Cycle Rated Masks)");
        ...
        nonCompatPane.setBounds(700,80,listSize.width+350,listSize.height+100);
        ...
        compatPane.setBounds(700,260,listSize.width+350,listSize.height+100);
